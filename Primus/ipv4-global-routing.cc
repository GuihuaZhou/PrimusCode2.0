...
<<<<<<< HEAD:CentralizedRouteTest/ipv4-global-routing.cc
  ofstream Logfout("/var/log/center.log",ios::app);
=======
  ofstream Logfout("/var/log/Primus.log",ios::app);
>>>>>>> 5ff4bb8faebbb8844cff5657a6efcdf5e47fe253:Primus/ipv4-global-routing.cc
...
=======
  // ofstream fout("/var/log/MappingTableIndex-output.txt",ios::app);
>>>>>>> 5ff4bb8faebbb8844cff5657a6efcdf5e47fe253:Primus/ipv4-global-routing.cc
  // end
  if (m_Node.level==1)
  {
    ...
    // 此处是用来添加ToR到server的路由，在sonic上暂时不需要
    // stringstream cmd;
    // cmd.str("");
...
=======
  ofstream fout("/var/log/MasterLinkTable-output.txt",ios::trunc);
>>>>>>> 5ff4bb8faebbb8844cff5657a6efcdf5e47fe253:Primus/ipv4-global-routing.cc
  fout.setf(ios::fixed, ios::floatfield);
...
<<<<<<< HEAD:CentralizedRouteTest/ipv4-global-routing.cc
  ...
  ofstream fout(filename.str().c_str(),ios::app);
=======
  ofstream fout("/var/log/MappingTable-output.txt",ios::app);
>>>>>>> 5ff4bb8faebbb8844cff5657a6efcdf5e47fe253:Primus/ipv4-global-routing.cc
  fout.setf(ios::fixed, ios::floatfield);
  fout.precision(9);//设置保留的小数点位数
...
<<<<<<< HEAD:CentralizedRouteTest/ipv4-global-routing.cc
  ...
  ofstream fout(filename.str().c_str(),ios::app);
=======
  ofstream fout("/var/log/PathEntryTable-output.txt",ios::app);
>>>>>>> 5ff4bb8faebbb8844cff5657a6efcdf5e47fe253:Primus/ipv4-global-routing.cc
  fout.setf(ios::fixed, ios::floatfield);
  fout.precision(9);//设置保留的小数点位数
...
<<<<<<< HEAD:CentralizedRouteTest/ipv4-global-routing.cc
  ...
  ofstream fout(filename.str().c_str(),ios::app);
=======
  ofstream fout("/var/log/CentrializedUpdateKernelTimeRecord.txt",ios::app);
>>>>>>> 5ff4bb8faebbb8844cff5657a6efcdf5e47fe253:Primus/ipv4-global-routing.cc
  fout.setf(ios::fixed, ios::floatfield);
  fout.precision(9);//设置保留的小数点位数
...
=======
  ofstream timeFout("/var/log/Primus.log",ios::app);
  ofstream exampleFout("/var/log/Primus.log",ios::app);
  ofstream nodeFout("/var/log/Primus.log",ios::app);
>>>>>>> 5ff4bb8faebbb8844cff5657a6efcdf5e47fe253:Primus/ipv4-global-routing.cc
