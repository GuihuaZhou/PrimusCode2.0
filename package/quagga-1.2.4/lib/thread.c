				  ...
				  debugargdef)
{
  ...
  // add by me
  if (strcmp(thread->funcname,"(bgp_routeadv_timer)")==0) alarm_time.tv_usec+=100000;
  else if (strcmp(thread->funcname,"(bgp_start_timer)")==0) alarm_time.tv_usec+=100000;
  else if (strcmp(thread->funcname,"(bgp_connect_timer)")==0) alarm_time.tv_usec+=800000;
  // end
