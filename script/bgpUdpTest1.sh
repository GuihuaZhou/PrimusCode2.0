...
pssh -i -h /home/guolab/host.txt "/home/guolab/modifyBGPConf 10;"
...
do
    ...
    sleep 17
    {
        ...
        pssh -i -h PCHost.txt -t 0 "/home/guolab/udp-client-my 192.168.1.2 100 2000 /home/guolab/output/udpResult.txt;" &
    ...
    sleep 30
    {
        ...
        pssh -i -h host.txt "sudo killall zebra; killall bgpd;"
        pssh -i -h PCHost.txt "killall udp-client-my;"
        pssh -i -H "root@10.0.8.86" "killall udp-server-my;"
        # 确保所有网卡都已恢复
        # Spine
        ssh root@10.0.8.60 "ifup eth1;ifup eth2;"
